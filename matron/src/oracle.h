...
extern void o_cut_buffer_copy_mono(int srcCh, int dstCh, float srcStart, float dstStart, float dur, float fadeTime, int reverse);
extern void o_cut_buffer_copy_stereo(float srcStart, float dstStart, float dur, float fadeTime, int reverse);
