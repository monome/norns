...
extern void w_handle_softcut_done_callback(int idx, int type, size_t num_to_expect);
extern void w_handle_softcut_process(int ch, float start, size_t size, float* data, size_t num_to_expect);
