...
void w_init(void) {
  ...
  lua_register_norns("screen_read_png", &_screen_read_png);
  lua_register_norns("screen_show_png", &_screen_show_png);
  lua_register_norns("screen_destroy_png", &_screen_destroy_png);
