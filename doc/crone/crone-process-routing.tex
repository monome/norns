...
\node [param, left = 1 of adc-cut-mul-l] (adc-cut) {\small{ADC-CUT}};
...
\node [param, left = 3 of ext-cut-mul-l] (ext-cut) {\small{EXT-CUT}};
\draw [->] (ext-cut-junc-l.center) -- (ext-cut-mul-l);
\draw [->] (ext-cut-junc-r.center) -- (ext-cut-mul-r);
...
\node (cut-aux-junc-l) at ($(cut-mul-l) + (0, 2)$) {\textbullet};
\node (cut-aux-junc-r) at ($(cut-mul-r) + (0, 2)$) {\textbullet};
...
\node [add] (aux-in-1-l) at ($(monitor-aux-mul-l) + (2, 0)$) {};
\node [add] (aux-in-1-r) at ($(monitor-aux-mul-r) + (2, 0)$) {};
...
\node [mul] (ext-aux-mul-l) at (ext-aux-junc-l -| aux-in-1-l) {};
\node [mul] (ext-aux-mul-r) at (ext-aux-junc-r -| aux-in-1-r) {};
...
\draw [->] (aux-in-1-l) -| (aux-in-2-r);
\draw [->] (aux-in-1-r) -| (aux-in-2-l);
\draw [->] (aux-in-2-l) -- (aux-fx-l);
\draw [->] (aux-in-2-r) -- (aux-fx-r);

% AUX level params
\node [param] (monitor-aux-level) at ($(monitor-aux-mul-r) + (-6, 0)$) {MONITOR-AUX-LEVEL};
...
\node [param] (cut-aux-level) at ($(monitor-aux-level) + (0, -1)$) {CUT-AUX-LEVEL};
...
\node [param] (ext-aux-level) at ($(ext-aux-mul-r) + (0, 2)$) {EXT-AUX-LEVEL};
\draw [gray, dashed] (ext-aux-level) -- (ext-aux-mul-r);
\draw [gray, dashed] (ext-aux-level) -- ++(0, -0.5) -| (ext-aux-mul-l);

\node [param] (aux-level) at (ext-aux-level |- aux-fx-mul-l) {AUX-LEVEL};
