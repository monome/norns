...
\foreach \i in {1,...,4}
{
	...
	\node (cut-out-split-\i) at ($(cut-\i) + (5, 0)$) {\textbullet};
	\draw (cut-\i) -- (cut-out-split-\i.center);
...
\foreach \i in {1,...,4}
{
	\node [mul] (cut-out-l-mul-\i) at ($(cut-out-split-\i) + (1, 0.5)$) {};
	\node [mul] (cut-out-r-mul-\i) at ($(cut-out-split-\i) + (1, -0.5)$) {};
	\draw [->] (cut-out-split-\i.center) -- (cut-out-l-mul-\i);
	\draw [->] (cut-out-split-\i.center) -- (cut-out-r-mul-\i);
}
