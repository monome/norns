...
namespace crone {
    ...
    public:
        ...
        private:
            static constexpr size_t maxFramesToWrite = 16384;  // FIXME, make this == ringbuf frames
            bool dataReady;
        ...
        private:
            ...
            static constexpr size_t maxFramesToRead = 16384; // FIXME, make this == ringbuf frames
