...
with{
    fsmax = 48000.0;
	  ...
	  lf_x = vslider("[2] lf_x [unit:Hz] [scale:log] [tooltip: low band cutoff frequency ] ", 200, 30, 1200, 1);
	  low_rt60 = vslider("[3] low_rt60 [unit:s] [tooltip: -60db decay time for low band ]", 1, 10, 3, 0.1);
	  mid_rt60 = vslider("[4] mid_rt60 [unit:s] [tooltip: -60db decay time for middle band ]", 1, 10, 3, 0.1);
