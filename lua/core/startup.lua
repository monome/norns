...
if util.file_exists(_path.home .. "/reverse.txt") then
  ...
  os.execute("jack_disconnect 'atropos:output_1' 'system:playback_1'")
  os.execute("jack_disconnect 'atropos:output_2' 'system:playback_2'")
  os.execute("jack_connect 'atropos:output_1' 'system:playback_2'")
  os.execute("jack_connect 'atropos:output_2' 'system:playback_1'")
  os.execute("jack_disconnect 'system:capture_1' 'atropos:input_1'")
  os.execute("jack_disconnect 'system:capture_2' 'atropos:input_2'")
  os.execute("jack_connect 'system:capture_1' 'atropos:input_2'")
  os.execute("jack_connect 'system:capture_2' 'atropos:input_1'")
end
