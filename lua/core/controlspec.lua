...
ControlSpec.MIDI = ControlSpec.new(0, 127, 'lin', 1, 64, "")
--- converts to a range for MIDI notes (default 60)
ControlSpec.MIDINOTE = ControlSpec.new(0, 127, 'lin', 1, 60, "")
--- converts to a range for MIDI velocity (default 64)
ControlSpec.MIDIVELOCITY = ControlSpec.new(1, 127, 'lin', 1, 64, "")
