-- @txt subtractive polysynth, controlled by grid
local tab = require 'tabutil.lua'
...
enc = function(n,delta)
   ...
   elseif n==3 then
      incParam(paramNames[curParamId], delta)
   end
    redraw() 
end
...
key = function(n)
    if n==2 then
       -- haha, randomize all the params or something
    end
